...
<a href="../index.php" style="position:relative;" class="previous-btn"><i class="fa-solid fa-left-long"></i></a>
  <div class="loginform-main-div1" style="position:absolute; top:0; z-index:-1;">
    <form class="loginform-main-div2" action="" method="post">
      ...
      <p>Don't have an account yet? <a href="doctorsignup.php">sign up</a></p>
      </div>
    </form>
  </div>
  ...
  <?php
    ...
    if ($res->num_rows > 0) 
    {
      ...
      $did=$row["doctor_id"];
      echo "<script>window.open('doctorlandingpage.php?did=$did','_self')</script>";
    } 
